...
const Treinamentos = () => {
    ...
    return (
        <>
            ...
            {/* Cronômetro */}
            <section className="mt-32 lg:h-[70vh] h-screen border-t-2 bg-custom-gradient text-white flex flex-col lg:flex-row items-center justify-center text-center gap-12 lg:gap-[20vw] px-4 sm:px-8 md:px-16">
